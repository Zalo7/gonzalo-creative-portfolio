...
const PROJECTS: Project[] = [
  {
    ...
    description: "Compilation of the best work from 2025.",
    video: "/videos/video5.MOV",
  ...
  },
  {
    ...
    description: "Full content strategy for a publicist brand.",
    video: "/videos/video-Flor.MP4",
  ...
  },
  {
    ...
    thumbnail: "/thumbnails/Mallorca.jpg",
    tags: ["Reels", "SMM"],
    client: "Freelance",
  },
  {
    ...
    category: "Video Editing",
    description: "Travel and lifestyle with cinematic.",
  ...
  },
  {
    ...
    category: "Content Strategy",
    description: "Travel and city landscape video with cinematic color grading",
  ...
  },
  {
    ...
    category: "Filmmaking",
    description: "Short film exploring visual storytelling with cinematic color grading.",
    video: "/videos/Itapema.mp4",
